  ...
  return (
    <div className="sidebar-container">
      ...
      <div className="sidebar-links">
        <NavLink className="sidebar-links" to="/add">
          <IoMdAddCircleOutline className="sidebar-icon" />
          <p className="sidebar-text">Add Product</p>
        </NavLink>
        <NavLink className="sidebar-links" to="/list">
          {/* <MdFormatListBulletAdd className="sidebar-icon" /> */}
          <p className="sidebar-text">List Product</p>
        </NavLink>
        <NavLink className="sidebar-links" to="/orders">
